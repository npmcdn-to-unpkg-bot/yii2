...
class Swift_Transport_Esmtp_Auth_NTLMAuthenticatorTest extends \SwiftMailerTestCase
{
    ...
    public function testLMv2Generator()
    {
        ...
        $login = $this->_getAuthenticator();
        $lmv2Result = $this->_invokePrivateMethod('createLMv2Password', $login, array($password, $login, $domain, $this->hex2bin($challenge), $this->hex2bin('ffffff0011223344')));
    ...
    public function testMessage3v1Generator()
    {
        ...
        $login = $this->_getAuthenticator();
        $message3 = $this->_invokePrivateMethod('createMessage3', $login, array($domain, $login, $workstation, $this->hex2bin($lmResponse), $this->hex2bin($ntlmResponse)));
    ...
    public function testGetDomainAndlogin()
    {
        $login = "DOMAIN\user";

        $login = $this->_getAuthenticator();
        list($domain, $user) = $this->_invokePrivateMethod('getDomainAndlogin', $login, array($login));
    ...
    public function testGetDomainAndloginWithExtension()
    {
        $login = "domain.com\user";
    ...
    public function testGetDomainAndloginWithAtSymbol()
    {
        $login = 'user@DOMAIN';
    ...
    public function testGetDomainAndloginWithAtSymbolAndExtension()
    {
    ...
    public function testAuthenticationFailureSendRsetAndReturnFalse()
    {
        ...
        $this->assertFalse($ntlm->authenticate($agent, $login.'@'.$domain, $secret, $this->hex2bin('30fa7e3c677bc301'), $this->hex2bin('f5ce3d2401c8f6e9')),
