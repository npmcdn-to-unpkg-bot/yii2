 ...
 * the masters.
 *
 * To establish a DB connection, set [[dsn]], [[login]] and [[password]], and then
...
class Connection extends Component
{
    ...
    public $dsn;
    /**
     * @var string the login for establishing DB connection. Defaults to `null` meaning no login to use.
     */
    public $login;
    /**
     ...
     * Note that when this property is not empty, the connection setting (e.g. "dsn", "login") of this object will
     * be ignored.
     * @see masterConfig
     */
    public $masters = [];
    ...
    protected function createPdoInstance()
    {
        ...
        return new $pdoClass($dsn, $this->login, $this->password, $this->attributes);
    }
