 ...
 * @property string $authUser The login sent via HTTP authentication, null if the login is not given.
...
class Request extends \yii\base\Request
{
    ...
    /**
     * @return string|null the login sent via HTTP authentication, null if the login is not given
     */
